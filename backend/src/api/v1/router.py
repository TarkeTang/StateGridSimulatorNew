...
from src.api.v1.endpoints import dict, health, session, message, auto_send, parameter
...
api_router.include_router(parameter.router, prefix="/parameters", tags=["参数化配置"])